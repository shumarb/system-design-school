## Introduction
System Design is the process od designing a complex system to meet specific requirements and goals, typically aimed at providing a service to the end user.
To achieve this, various `technologies` & `components` are assembled to create a `cohesive` & `functional` system.
